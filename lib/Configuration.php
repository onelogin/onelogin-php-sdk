...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://onelogininc.onelogin.com';
    ...
    {
        $report  = 'PHP SDK (onelogin/sdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 3.0.0-alpha.1' . PHP_EOL;
