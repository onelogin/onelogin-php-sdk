...
class Rule implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets conditions
     *
     * @param \onelogin/sdk\Model\Condition[]|null $conditions An array of conditions that the user must meet in order for the rule to be applied.
     *
     * @return self
     */
     ...
     * Gets actions
     *
     * @return \onelogin/sdk\Model\Action[]|null
     */
     ...
     * Sets actions
     *
     * @param \onelogin/sdk\Model\Action[]|null $actions An array of actions that will be applied to the users that are matched by the conditions.
     *
     * @return self
     */
