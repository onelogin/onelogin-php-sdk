...
class Hook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'options' => '\OpenAPI\Client\Model\HookOptions',
        'conditions' => '\OpenAPI\Client\Model\HookConditionsInner[]',
        'created_at' => 'string',
        'updated_at' => 'string'
    ];
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\HookOptions|null
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\HookOptions|null $options options
     *
     * @return self
     */
     ...
     * Gets conditions
     *
     * @return \OpenAPI\Client\Model\HookConditionsInner[]|null
     */
     ...
     * Sets conditions
     *
     * @param \OpenAPI\Client\Model\HookConditionsInner[]|null $conditions An array of objects that let you limit the execution of a hook to users in specific roles.
     *
     * @return self
     */
