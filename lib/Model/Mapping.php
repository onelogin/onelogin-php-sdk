...
class Mapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets conditions
     *
     * @param \OpenAPI\Client\Model\Condition[]|null $conditions An array of conditions that the user must meet in order for the mapping to be applied.
     *
     * @return self
     */
     ...
     * Gets actions
     *
     * @return \OpenAPI\Client\Model\Action[]
     */
     ...
     * Sets actions
     *
     * @param \OpenAPI\Client\Model\Action[] $actions An array of actions that will be applied to the users that are matched by the conditions.
     *
     * @return self
     */
